...
.from("#rpm-numbers", {duration:0.4, alpha:0, visibility:"visible"}, "right-labels")
.to("#rpm-numbers", {visibility:"visible"}, "right-labels-stay")
.from("#rpm-middle", {duration:0.4, scale:0.5, alpha:0, visibility:"visible"}, "right-labels")
.to("#rpm-middle", {visibility:"visible"}, "right-labels-stay")
.from("#RPMx1000", {duration:0.4, scale:0.5, alpha:0, visibility:"visible"}, "right-labels")
...
.from("#VOLTS-label", {duration:0.4, scale:0.5, alpha:0, visibility:"visible"}, "right-labels")
