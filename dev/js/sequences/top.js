...
topTL.from("#right-dice", {duration:1.3, x:-80, y:325, alpha:0, visibility:"visible"},"dice")
.to("#right-dice", {visibility:"visible"},"seen")
.from("#right-dice-dot-TL", {duration:1.3, x:-80, y:325, alpha:0, visibility:"visible"},"dice")
.to("#right-dice-dot-TL", {visibility:"visible"},"seen")
.from("#right-dice-dot-BL", {duration:1.3, x:-80, y:325, alpha:0, visibility:"visible"},"dice")
.to("#right-dice-dot-BL", {visibility:"visible"},"seen")
.from("#right-dice-dot-TR", {duration:1.3, x:-80, y:325, alpha:0, visibility:"visible"},"dice")
.to("#right-dice-dot-TR", {visibility:"visible"},"seen")
.from("#right-dice-dot-BR", {duration:1.3, x:-80, y:325, alpha:0, visibility:"visible"},"dice")
.to("#right-dice-dot-BR", {visibility:"visible"},"seen")
.from("#left-dice", {duration:1.3, x:80, y:325, alpha:0, visibility:"visible"},"dice")
.to("#left-dice", {visibility:"visible"},"seen")
.from("#left-dice-dot", {duration:1.3, x:80, y:325, alpha:0, visibility:"visible"},"dice")
