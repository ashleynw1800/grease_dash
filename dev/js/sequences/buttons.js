...
buttonsTL.from("#button-1", {duration:1, alpha:0, visibility:"visible"}, "buttons")
.to("#button-1", {visibility:"visible"}, "buttons-stay")
.from("#button-2", {duration:1.2, y:-15, alpha:0, visibility:"visible"}, "buttons")
.to("#button-2", {visibility:"visible"}, "buttons-stay")
.from("#button-3", {duration:1.4, y:0, alpha:0, visibility:"visible"}, "buttons")
.to("#button-3", {visibility:"visible"}, "buttons-stay")
.from("#button-4", {duration:1.5, y:0, alpha:0, visibility:"visible"}, "buttons")
